...
# tests/unit/app/repositories/test_user_repository.py
...
def mock_session(mocker):
    ...
    """
    with mocker.patch('app.repositories.user_repository.Session', autospec=True) as MockSession:
        yield MockSession
...
def test_get_by_id(mocker, user_repository, mock_session):
    """
    ...
    mocker.patch('app.repositories.user_repository.Session', return_value=mock_session)

    mock_session.get.return_value = DBUser(id=1, username='testuser')
